...
public class FilialServiceTest {
    ...
    public void testSalvarFilial() throws SQLException {
        ...
        FilialHotel f1 = new FilialHotel("Martins", "Rua 1", 123, "Cidade1", "Estado1", true);
        FilialHotel f2 = new FilialHotel("SoftwareHouse", "Rua 2", 456, "Cidade2", "Estado2", false);
        FilialHotel f3 = new FilialHotel("Digital House", "Rua 3", 789, "Cidade3", "Estado3", true);
        FilialHotel f4 = new FilialHotel("AWS Cloud", "Rua 4", 12, "Cidade4", "Estado4", false);
        FilialHotel f5 = new FilialHotel("Google", "Rua 5", 345, "Cidade5", "Estado5", true);
