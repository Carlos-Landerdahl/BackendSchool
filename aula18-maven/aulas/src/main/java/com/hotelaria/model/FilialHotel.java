...
public class FilialHotel {
    ...
    public FilialHotel(int id, String nomeFilial, String rua, int numero, String cidade, String estado, Boolean cincoEstrelas) {
        this.id = id;
    ...
    public FilialHotel(String nomeFilial, String rua, int numero, String cidade, String estado, Boolean cincoEstrelas) {
        this.nomeFilial = nomeFilial;
        this.rua = rua;
        this.numero = numero;
        this.cidade = cidade;
